      ...
      <nav class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex space-x-6">
            ...
            <a href="#skills" class="text-text-primary hover:text-primary transition-colors">Skills</a>
            <a href="#contact" class="text-text-primary hover:text-primary transition-colors">Contact</a>
          </div>
        </div>
      </nav>
    </header>
